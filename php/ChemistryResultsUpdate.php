...
//$Item_desc_name=mysqli_query($con,"select * from test_item_cat where item_name='$testname' and Tst_Cat_ID='TCAT102'");
    ...
    if($flag==1){
        ...
        //echo 'update query executed';
         ...
         $query="insert into patient_exam (visit_id,Tst_Cat_ID,Item_desc,date,time,result) "
                                . "values('$visit_id','TCAT102','$testname','$formatted_date','$time','$result')";
         $updateresult=  mysqli_query($con, $query);
