...
$result=mysqli_query($con,"select ip.Name,ie.date,ie.time,ie.result from output_exam ie join output ip on ip.Output_ID=ie.`Output_ID` where ie.date between '$formatted_start_date' and '$formatted_end_date' and ie.`Visit_ID`='$visit_id' order by ie.date,ie.time,ip.Name");
if($shift=='day'){
