                                             ...
                                             items:[
                                                 //text container
                                                 {
                                                    ...
                                                    items:[
                                                        {
                                                            ...
                                                            ui:'plain',
                                                            width:'140px',
                                                            itemid:'SerologyViewDefinition',
                                                            html: '<div style="text-align: center; border: 1px solid black; padding: 5px">View Definition</div>',
                                                                ...
                                                                items:[
                                                                    {
                                                                         xtype:'selectfield',
                                                                         width:'140px',
                                                                         itemid:'Serologyfilternotesid',
                                                                          name:'Serologyfilternotesid',
                                                                          options:[
                                                   ...
                                                   // Accordion notes for chemistry labs
                                                       {
                                                                xtype:'accordionlist',
                                                                store: Ext.create('MVF.store.SerologyLabNotesStore'),
                                                                flex: 1,
                                                                height:'77%',
                                                                width:'99%',
                                                                indent: true,
